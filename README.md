...
* **Safety:** Safety data is collected from DC Open Data for 2019 and 2022 (https://opendata.dc.gov/datasets/crashes-in-dc/explore).  
...
### Conclusions
The study corridor saw a substantial increase in bike trips and share. The increase in biking spilled over into the study area. <p>
Relative to controls, walk share declined slightly in both the study corridor and study area. This doesn't necessarily mean pedestrian trips fell, but rather that they fell as a share of total trips. Biking may have replaced some trips that were previously made on foot. <p>
Vehicle trip share fell very slightly in the study corridor despite seeing marginal increases in the study area and controls. Ultimately, this suggests that the street design change had a limited effect on vehicle movements. <p>
Safety saw no statistically significant changes, though I would caution against reading into these results due to limited data and methodological limitations. <p>
Business sales in the two Census Tracts used as proxies for the study corridor saw significant growth, particularly after the street design intervention. This growth greatly outpaced the average in the District. <p>
Overall, the intervention had significant benefits for travel by bicycle and economic activity. It does not appear to have had a negative effect on safety. And it did not dramatically affect travel by other modes; indeed, vehicle travel, at least in terms of trips and trip share, was not seriously affected. 
